...
function dataHandling(_array) {
    let index = 0;
    while(index < _array.length) {
        console.log(``);
        console.log(`Nomor ID: ${_array[index][0]}`);
        console.log(`Nama Lengkap: ${_array[index][1]}`);
        console.log(`TTL: ${_array[index][2]} ${_array[index][3]}`);
        console.log(`Hobi: ${_array[index][4]}`);
        index++;
    }
}
